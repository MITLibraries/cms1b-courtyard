 ...
 * @uses courtyard_admin_header_style()
 * @uses courtyard_admin_header_image()
 */
function courtyard_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'courtyard_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'courtyard_header_style',
		'admin-head-callback'    => 'courtyard_admin_header_style',
		'admin-preview-callback' => 'courtyard_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'courtyard_custom_header_setup' );

if ( ! function_exists( 'courtyard_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see courtyard_custom_header_setup().
 */
function courtyard_header_style() {
 ...
 * @see courtyard_custom_header_setup().
 */
function courtyard_admin_header_style() {
?>
	<style type="text/css">
 ...
 * @see courtyard_custom_header_setup().
 */
function courtyard_admin_header_image() {
?>
	<div id="headimg">
